...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.contactCard.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-cards.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_position') ? 'is-invalid' : '' }}" type="text" name="company_position" id="company_position" value="{{ old('company_position', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_website') ? 'is-invalid' : '' }}" type="text" name="company_website" id="company_website" value="{{ old('company_website', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('handphone_number') ? 'is-invalid' : '' }}" type="text" name="handphone_number" id="handphone_number" value="{{ old('handphone_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('office_phone_number') ? 'is-invalid' : '' }}" type="text" name="office_phone_number" id="office_phone_number" value="{{ old('office_phone_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram_url') ? 'is-invalid' : '' }}" type="text" name="instagram_url" id="instagram_url" value="{{ old('instagram_url', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('wechat') ? 'is-invalid' : '' }}" type="text" name="wechat" id="wechat" value="{{ old('wechat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slogan') ? 'is-invalid' : '' }}" type="text" name="slogan" id="slogan" value="{{ old('slogan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mission') ? 'is-invalid' : '' }}" type="text" name="mission" id="mission" value="{{ old('mission', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vision') ? 'is-invalid' : '' }}" type="text" name="vision" id="vision" value="{{ old('vision', '') }}">
