    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-cards.update", [$contactCard->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_slug') ? 'is-invalid' : '' }}" type="text" name="url_slug" id="url_slug" value="{{ old('url_slug', $contactCard->url_slug) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('douyin') ? 'is-invalid' : '' }}" type="text" name="douyin" id="douyin" value="{{ old('douyin', $contactCard->douyin) }}">
