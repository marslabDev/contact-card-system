...
@can('social_medium_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'SocialMedium', 'route' => 'admin.social-media.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\SocialMedium::TYPE_SELECT as $key => $item)
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SocialMedium').DataTable(dtOverrideGlobals);
